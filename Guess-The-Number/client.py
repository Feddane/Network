...
user_name = ""                                                       # User name
bg_main = PhotoImage(file="images/menu.png")                                # Background Image - Main Menu
bg_score = PhotoImage(file="images/score.png")                              # Background Image - Score board
bg_login = PhotoImage(file="images/login.png")                              # Background Image - User name/ Login
bg_game = PhotoImage(file="images/game.png")                                # Background Image - Game screen
